class AssignmentsController < ApplicationController
  ...
  def destroy
    @assignment.destroy
    respond_to do |format|
      format.html { redirect_to course_assignments_url, notice: 'Assignment was successfully destroyed.' }
  ...
  private
    ...
    def assignment_params
      params.require(:assignment).permit(:title, :statement, :start_date, :end_date, :course_id)
    end
end
